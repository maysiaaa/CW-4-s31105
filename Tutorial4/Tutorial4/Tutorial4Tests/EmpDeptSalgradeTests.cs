...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptNos = depts.Where(e => e.Loc == "CHICAGO").Select(d => d.DeptNo).ToList();
        List<Emp> result = emps.Where(e => deptNos.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = from e in emps
            join s in grades on 4 equals 4
